...
export function httpGet(url, onResponse, onError) {
    return request("get", url, null, (response) => onResponse(response), (response) => onError(response));
}
export function httpPost(url, body = null, onResponse, onError) {
    return request("post", url, body, (response) => onResponse(response), (response) => onError(response));
}
export function httpPut(url, body = null, onResponse, onError) {
    return request("put", url, body, (response) => onResponse(response), (response) => onError(response));
}
export function httpDelete(url, body = null, onResponse, onError) {
    return request("delete", url, body, (response) => onResponse(response), (response) => onError(response));
}
